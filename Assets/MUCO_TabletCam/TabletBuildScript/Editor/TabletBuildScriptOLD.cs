namespace MUCO.Build.Editor
{
    ...
    /// </summary>
    public static class TabletBuildScriptOLD
    {
        ...
        private static void Build(string extraScenePath, string pathFolder, 
            string buildFolder, BuildTarget target, BuildOptions options, 
            ForceVRSupportedModes forceVRSupported, bool devBuild)
        {
            AddExtraScene(extraScenePath);
