...
namespace absurdjoy
{
    public class PlayerAvatar : MonoBehaviour
    {
        ...
        /// </summary>
        public void LinkWithLocal(Transform localHead, OVRCustomSkeleton localLeftSkeleton, OVRCustomSkeleton localRightSkeleton, Transform localRoot)
        {
        ...
        private void Update()
        {
            if (realtimeView.isOwnedLocallySelf)
            {
                ...
                MatchTransform(localRoot, root.transform);
            }
        }
